...
export const sites: Site[] = (
  ...
  (
    [name, address, city, postalCode, surfaceM2, lat, lng, openedAt, status, smsNumber, pdl, pce],
    i,
  ) => ({
    id: u(`2${i}`),
    tenantId: u('1'),
  ...
  alerts: (
    [
      [
        'critical',
        'power',
        '2 sèche-linge hors service',
        'Vénissieux Centre',
        '2026-06-29T07:48:00.000Z',
      ],
      [
        'critical',
        'droplet',
        "Surconsommation d'eau détectée",
        'Vénissieux Centre',
        '2026-06-29T07:22:00.000Z',
      ],
      [
        'warning',
        'euro',
        'Espèces à collecter — seuil atteint',
        'Lyon-3 Guillotière',
...
export function machineDetail(id: string): MachineDetail {
  ...
  return {
    ...
    history: [
      ...
      {
        at: '2026-06-29T11:21:00.000Z',
        program: 'Synthétique 30°',
        durationMin: 28,
        amount: e(400),
      },
...
export const revenue: RevenueSummary = {
  ...
  recentRefunds: [
    {
      id: u('60'),
      reason: 'Cycle interrompu',
      machineCode: 'LL-03',
      siteName: 'Vénissieux Centre',
      at: '2026-06-29T06:00:00.000Z',
      amount: e(450),
    },
    {
      id: u('61'),
      reason: 'Trop-perçu sans contact',
      machineCode: null,
      siteName: 'Lyon-3 Guillotière',
      at: '2026-06-28T08:00:00.000Z',
      amount: e(200),
    },
    {
      id: u('62'),
      reason: 'Sèche-linge HS',
      machineCode: 'SL-06',
      siteName: 'Vénissieux Centre',
      at: '2026-06-28T08:00:00.000Z',
      amount: e(300),
...
export const energy: EnergySummary = {
  ...
  meters: [
    ...
    },
    {
      ...
      unit: 'm³',
      deltaPct: 11,
      anomaly: 'Fuite probable · Vénissieux',
      series: [],
    },
    {
      kind: 'gas',
...
export const maintenance: MaintenanceSummary = {
  ...
  tickets: (
    [
      ...
      [
        '#2240',
        "Surconsommation d'eau — fuite probable",
        'Vénissieux Centre',
        'high',
        'assigned',
        'alarm',
    ...
    siteId:
      sites.find(
        (s) => s.name === siteName || s.name.startsWith(siteName) || siteName.startsWith(s.name),
      )?.id ?? u('20'),
    siteName,
    machineCode: null,
    priority,
  ...
  worklist: [
    {
      time: '09:00',
      technicianName: 'Karim B.',
      task: 'SL-03 — remplacement résistance',
      siteName: 'Vénissieux',
      status: 'en_route',
    },
    {
      time: '11:30',
      technicianName: 'Karim B.',
      task: 'Recherche fuite réseau eau',
      siteName: 'Vénissieux',
      status: 'planned',
    },
    {
      time: '14:00',
      technicianName: 'Sophie D.',
      task: 'Monnayeur — déblocage',
      siteName: 'Villeurbanne',
      status: 'planned',
    },
    {
      time: '16:00',
      technicianName: 'Externe · Speed Queen',
      task: 'Diagnostic essorage',
      siteName: 'Paris-11',
      status: 'to_confirm',
    },
  ],
...
export const customers: CustomersSummary = {
  ...
  segments: [
    {
      ...
      name: 'Réguliers',
      count: 1284,
      definitionLabel: '≥ 2 passages / mois',
      sharePct: 46,
    },
    {
      id: u('a1'),
      name: 'Occasionnels',
      count: 2057,
      definitionLabel: '1 passage / 30–90 j',
      sharePct: 74,
    },
    {
      id: u('a2'),
      name: 'À risque (churn)',
      count: 341,
      definitionLabel: 'Aucun passage > 90 j',
      sharePct: 18,
    },
    {
      id: u('a3'),
      name: 'Nouveaux (30 j)',
      count: 212,
      definitionLabel: 'Première visite récente',
      sharePct: 12,
    },
  ],
  loyaltyTiers: [
  ...
  campaigns: [
    {
      id: u('b0'),
      label: 'SMS heures creuses',
      channel: 'sms',
      status: 'active',
      audienceLabel: 'Réguliers · envoi auto',
    },
    {
      id: u('b1'),
      label: 'E-mail réactivation churn',
      channel: 'email',
      status: 'draft',
      audienceLabel: '341 clients à risque',
    },
    {
      id: u('b2'),
      label: 'Push fin de cycle',
      channel: 'push',
      status: 'active',
      audienceLabel: 'Tous · temps réel',
    },
  ],
};
...
export const network: NetworkSummary = {
  ...
  standardizationLabel:
    "4 / 6 sites conformes au référentiel d'enseigne (tarifs, signalétique, OPERAT).",
  ranking: (
    [
...
export const admin: AdminSummary = {
      ...
      items: [
        {
          id: 'lm_control',
          name: 'LM Control',
          kind: 'payment_central',
          kindLabel: 'Centrale de paiement',
          status: 'connected',
          note: 'Sync il y a 3 min',
          lastSyncAt: NOW,
        },
        {
          id: 'eas',
        ...
        },
        {
          ...
          name: 'Speed Queen',
          kind: 'machine_brand',
          kindLabel: 'Parc machines',
          status: 'connected',
          note: 'Sync il y a 8 min',
          lastSyncAt: NOW,
        },
        {
          id: 'girbau',
      ...
      items: [
        {
          ...
          name: 'Mistral AI',
          kind: 'llm',
          kindLabel: 'Synthèses & assistant',
          status: 'connected',
          note: 'Modèle small / large',
          lastSyncAt: NOW,
        },
        {
          id: 'stripe',
          name: 'Stripe',
          kind: 'billing',
          kindLabel: 'Facturation SaaS & paiement',
          status: 'connected',
          note: 'Mode live',
          lastSyncAt: NOW,
        },
        {
          ...
          name: 'Pennylane',
          kind: 'accounting',
          kindLabel: 'Connecteur comptable',
          status: 'not_connected',
          note: 'Configuration requise',
          lastSyncAt: null,
        },
      ...
      items: [
        {
          ...
          name: 'Enedis',
          kind: 'energy',
          kindLabel: 'Données de consommation',
          status: 'connected',
          note: 'Sync quotidienne',
          lastSyncAt: NOW,
        },
        {
          id: 'operat',
          name: 'ADEME OPERAT',
          kind: 'energy',
          kindLabel: 'Déclaration tertiaire',
          status: 'not_connected',
          note: 'Configuration requise',
          lastSyncAt: null,
        },
        ...
        },
        {
          ...
          name: 'Web Push',
          kind: 'messaging',
          kindLabel: 'Notifications fin de cycle',
          status: 'connected',
          note: 'Actif',
          lastSyncAt: NOW,
        },
  ...
  audit: [
    {
      id: u('c0'),
      at: '2026-06-29T12:32:00.000Z',
      userLabel: 'S. Diallo',
      action: 'a validé un remboursement',
      entityLabel: 'Cycle LL-03 · 4,50 €',
    },
    {
      id: u('c1'),
      at: '2026-06-29T11:58:00.000Z',
      userLabel: 'Système',
      action: 'a ouvert un ticket automatique',
      entityLabel: '#2241 · SL-03',
    },
    {
      id: u('c2'),
      at: '2026-06-29T09:20:00.000Z',
      userLabel: 'M. Lefort',
      action: 'a modifié la grille tarifaire',
      entityLabel: 'Heures creuses · Lyon-3',
    },
    {
      id: u('c3'),
      at: '2026-06-29T07:05:00.000Z',
      userLabel: 'S. Diallo',
      action: 'a invité un utilisateur',
      entityLabel: 'k.benali@laveo.fr · Technicien',
    },
    {
      id: u('c4'),
      at: '2026-06-29T06:40:00.000Z',
      userLabel: 'Système',
      action: 'a généré le dossier OPERAT',
      entityLabel: '6 sites · exercice 2025',
    },
  ],
};
  ...
  items: (
    [
      [
        ...
        'power',
        '2 sèche-linge hors service',
        'SL-03 et SL-06 signalés HS par la centrale EAS.',
        'Vénissieux Centre',
        '2026-06-29T07:48:00.000Z',
        false,
      ],
      [
        ...
        'droplet',
        "Surconsommation d'eau détectée",
        '+38 % vs référence sur 24 h — fuite probable.',
        'Vénissieux Centre',
        '2026-06-29T07:22:00.000Z',
        false,
      ],
      [
        ...
        'euro',
        'Espèces à collecter',
        'Monnayeur à 92 % de sa capacité — collecte à planifier.',
        'Lyon-3 Guillotière',
        '2026-06-29T07:00:00.000Z',
        false,
      ],
      [
        ...
        'Recettes',
        'alert',
        'Écart de réconciliation 24 €',
        'Encaissé inférieur au théorique sur la collecte du jour.',
        'Villeurbanne',
        '2026-06-29T06:00:00.000Z',
        false,
      ],
      [
        ...
        'wrench',
        'Maintenance préventive planifiée',
        'Intervention 09:00 — remplacement résistance SL-03.',
        'Paris-11 Voltaire',
        '2026-06-29T07:00:00.000Z',
        true,
      ],
      [
        ...
        'Énergie',
        'euro',
        'Dossier OPERAT généré',
        'Déclaration 2025 prête pour vos 6 sites.',
        'Réseau',
...
export const supportTickets: SupportTicket[] = (
  [
    [
      'SUP-1042',
      'Écart de réconciliation sur Lyon-3',
      '1',
      'Groupe Lavéo',
      'Marc Lefort',
      'marc@laveo.fr',
      ...
      'high',
      'billing',
      '2026-06-29T06:20:00.000Z',
      [
        [
          'client',
          'Marc Lefort',
          'Bonjour, un écart de 4,50 € persiste sur la journée d’hier pour Lyon-3.',
          '2026-06-29T06:20:00.000Z',
        ],
      ],
    ],
    [
      ...
      'urgent',
      'technical',
      '2026-06-29T05:10:00.000Z',
      [
        [
          'client',
          'Julie Moreau',
          'Le SL-03 ne remonte plus de données depuis ce matin.',
          '2026-06-29T05:10:00.000Z',
        ],
        [
          'staff',
          'Support LavoPilot',
          'Merci, nous vérifions le connecteur Speed Queen — retour sous 1 h.',
          '2026-06-29T05:40:00.000Z',
        ],
      ],
    ],
    [
      'SUP-1040',
      'Ajouter un rôle « comptable lecture seule »',
      'a3',
      'Netteo',
      'Léa Fontaine',
      'lea@netteo.com',
      ...
      'normal',
      'feature',
      '2026-06-28T16:02:00.000Z',
      [
        [
          'client',
          'Léa Fontaine',
          'Serait-il possible d’avoir un rôle comptable en lecture seule ?',
          '2026-06-28T16:02:00.000Z',
        ],
      ],
    ],
    [
      ...
      [
        [
          'client',
          'Nadia Cherif',
          'Je ne retrouve pas ma facture de juin.',
          '2026-06-27T11:30:00.000Z',
        ],
        [
          'staff',
          'Support LavoPilot',
          'La voici en pièce jointe, désolé pour la gêne.',
          '2026-06-27T13:12:00.000Z',
        ],
      ],
    ],
    [
      ...
      [
        [
          'client',
          'Hugo Blanc',
          'Merci de supprimer notre compte conformément au RGPD.',
          '2026-06-20T09:00:00.000Z',
        ],
        [
          'staff',
          'Support LavoPilot',
          'Compte purgé, confirmation envoyée par e-mail.',
