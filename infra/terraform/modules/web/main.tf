# Web hosting: private S3 origin + CloudFront with Origin Access Control, SPA
# routing (403/404 → /index.html), and a cache policy. TLS via ACM.

locals {
  tags = merge(var.tags, { module = "web" })
}
